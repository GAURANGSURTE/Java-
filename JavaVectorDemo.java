...
public class JavaVectorDemo {
    ...
    public static void main(String[] args) {
        // vectors are dynamic array where they grow and shrink as needed and they are synchronized
        // ArrayList are not synchronized and they are not thread safe but are faster
        // can be synchronized using collections.synchronizedList() method
